...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "b35f9a8dc3e9204733ce";
...
const normalize_1 = __webpack_require__(/*! utils/normalize */ "./src/utils/normalize.ts");
const server_1 = __webpack_require__(/*! server */ "./src/server.ts");
const { PORT } = process.env;
const port = normalize_1.normalizePort(PORT || '8080');
server_1.start(port);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.watch = exports.check = exports.setMailNotification = exports.getMessageBox = exports.getMailBox = exports.getMailNotification = exports.sendMessage = exports.sendMail = exports.readMail = void 0;
const service_pb_1 = __webpack_require__(/*! @oojob/protorepo-mail-node/service_pb */ "@oojob/protorepo-mail-node/service_pb");
exports.readMail = (call, callback) => {
    const mail = new service_pb_1.Mail();
    callback(null, mail);
};
exports.sendMail = (call, callback) => { };
exports.sendMessage = (call, callback) => { };
exports.getMailNotification = (call, callback) => { };
exports.getMailBox = (call, callback) => { };
exports.getMessageBox = (call, callback) => { };
exports.setMailNotification = (call, callback) => { };
exports.check = (call, callback) => { };
exports.watch = (call, callback) => { };
...
const mail_service_1 = __webpack_require__(/*! ./mail.service */ "./src/mail.service.ts");
...
class MailServer {
    constructor() {
        this.start = (port) => {
            ...
            try {
                server.addService(protorepo_mail_node_1.MailServiceService, {
                    readMail: mail_service_1.readMail,
                    sendMail: mail_service_1.sendMail,
                    sendMessage: mail_service_1.sendMessage,
                    setMailNotification: mail_service_1.setMailNotification,
                    watch: mail_service_1.watch,
                    check: mail_service_1.check,
                    getMailBox: mail_service_1.getMailBox,
                    getMailNotification: mail_service_1.getMailNotification,
                    getMessageBox: mail_service_1.getMessageBox
                });
